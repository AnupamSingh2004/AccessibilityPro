  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">Severity Distribution</h2>
          <p className="text-gray-400 text-sm">Accessibility issues breakdown by severity level</p>
        </div>
        <div className="flex items-center gap-2 text-sm font-medium text-gray-400 bg-gray-800/50 px-4 py-2 rounded-full border border-gray-700/50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Issue Breakdown</h3>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-500 text-sm">{formatPercentage(item.count)} of total</span>
                    </div>
                    <span 
      ...
      <div 
        className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-800/50"
        style={{ 
          opacity: isAnimating ? 1 : 0,
